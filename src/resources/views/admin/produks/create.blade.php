    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.produks.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('produkname') ? 'is-invalid' : '' }}" type="text" name="produkname" id="produkname" value="{{ old('produkname', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kadaluarsa') ? 'is-invalid' : '' }}" type="text" name="kadaluarsa" id="kadaluarsa" value="{{ old('kadaluarsa', '') }}" required>
